...
describe User do
  ...
  describe "when email format is not valid" do
    it "should be invalid" do
      adresses = %w[user@foo user_at_foo user@foo.]      
  ...
  describe "when email format is valid" do
    it "should be valid" do
      adresses = %w[user@user.com user@user.COM user@f.b.org a+b@foo.bar "user"@foo.com]
  ...
  describe "micropost association" do
    ...
    describe "status" do
      ...
      before do
        ...
        3.times { followed_user.microposts.create(content: "Foobar")}
      end
